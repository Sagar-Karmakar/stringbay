            ...
            <div class="account-wrapper mt--100 mt-lg--440">
                <div class="left-side">
                    <div class="section-header" data-aos="zoom-out-down" data-aos-duration="1200">
                        ...
                        <p>You can log in to your OnlineBid account here.</p>
                    </div>
                    {{-- <ul class="login-with">
                        <li>
                ...
                <div class="right-side cl-white">
                    <div class="mb-0 section-header">
                        <h3 class="mt-0 title">NEW HERE?</h3>
                    ...
                    <div class="col-sm-6 col-lg-3" data-aos="fade-down" data-aos-duration="1800">
                        <div class="footer-widget widget-follow">
                            ...
                            <ul class="links-list">
                                ...
                                <li>
                                    <a href="#0"><i class="fas fa-envelope-open-text"></i><span class="__cf_email__" data-cfemail="442c21283404212a232b302c2129216a272b29">[email&#160;protected]</span></a>
                                </li>
                                <li>
