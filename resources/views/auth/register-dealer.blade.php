            ...
            <div class="account-wrapper mt--100 mt-lg--440">
                <div class="left-side">
                    <div class="section-header" data-aos="zoom-out-down" data-aos-duration="1200">
                        <h2 class="title">SIGN UP AS A DEALER</h2>
                    ...
                    <form class="login-form" method="POST" action="{{ route('register-dealer') }}">
                        @csrf
                        ...
                        <div class="form-group checkgroup ">
                            <input type="checkbox" name="terms" id="check"><label for="check">The OnlineBid Terms of Use apply</label>
                        </div>
                ...
                <div class="right-side cl-white">
                    <div class="mb-0 section-header">
                        <h3 class="mt-0 title">ALREADY HAVE AN ACCOUNT?</h3>
                        <p>Log in and go to your Dashboard.</p>
                        <a href="{{ route('login') }}" class="custom-button transparent">Login</a>
                        <a href="{{ route('register') }}" class="custom-button transparent" style="margin-top: 10px">Sign Up As A Customer</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-sm-6 col-lg-3" data-aos="fade-down" data-aos-duration="1800">
                        <div class="footer-widget widget-follow">
                            ...
                            <ul class="links-list">
                                ...
                                <li>
                                    <a href="#0"><i class="fas fa-envelope-open-text"></i><span class="__cf_email__" data-cfemail="c6aea3aab686a3a8a1a9b2aea3aba3e8a5a9ab">[email&#160;protected]</span></a>
                                </li>
                                <li>
