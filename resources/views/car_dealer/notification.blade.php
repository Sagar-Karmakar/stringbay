            ...
            <div class="row justify-content-center">
                <div class="col-sm-10 col-md-7 col-lg-4">
                    <div class="dashboard-widget mb-30 mb-lg-0">
                        ...
                        <ul class="dashboard-menu">
                            ...
                            <li>
                                <a href="{{ route('car_dealer.notification') }}"><i class="flaticon-alarm"></i>My Alerts</a>
                            </li>
                            @endcan
                            <li>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="dashboard-widget">
                        <h5 class="mb-10 title">Notifications</h5> <br>
                        <div>
                            <div class="container">
                                ...
                                @foreach ($notifications as $notification)
                                    <div class="mb-3 card">
                                        <div class="card-body">
                                            <h5 class="card-title">The Car of "{{ $notification->data['car_make'] }} {{ $notification->data['car_model'] }}" </h5> <br>
                                            <p class="card-text">Request Customer Name: {{ $notification->data['customer_name'] }}</p>
                                            <p class="card-text">Request Date and time: {{ $notification->created_at->format('d-m-Y H:i') }}</p>
                                            {{-- <a href="{{ $notification->data['car_link'] }}" class="btn btn-primary">View Car Details</a> --}}
                                        </div>
                                    </div>
                                @endforeach
